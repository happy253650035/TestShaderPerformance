...
inline half OneMinusReflectivityFromMetallic(half metallic)
{
    ...
    //half oneMinusDielectricSpec = unity_ColorSpaceDielectricSpec.a;
	 half oneMinusDielectricSpec = 1.0 - 0.04;
    return oneMinusDielectricSpec - metallic * oneMinusDielectricSpec;
}

inline half3 DiffuseAndSpecularFromMetallic (half3 albedo, half metallic, out half3 specColor, out half oneMinusReflectivity)
{
	half3 unity_ColorSpaceDielectricSpec_Copy;
	unity_ColorSpaceDielectricSpec_Copy=GammaToLinearSpace(unity_ColorSpaceDielectricSpec.rgb);
    specColor = lerp (fixed3(0.04,0.04,0.04), albedo, metallic);
