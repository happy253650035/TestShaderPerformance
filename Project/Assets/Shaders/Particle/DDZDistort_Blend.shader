...
Shader "ZJY/Effect/Particles/DDZDistort_Blend" 
{
	Properties 
	{
		...
		SubShader 
		{
			...
			Pass 
			{
				...
				half4 frag( v2f i ) : COLOR
				{
					...
					i.uvgrab.x += (offsetColor1.r + offsetColor2.r) * _HeatForce;
					i.uvgrab.y += (offsetColor1.g + offsetColor2.g) * _HeatForce;
					half4 col = tex2Dproj( _GrabTexture, UNITY_PROJ_COORD(i.uvgrab));
					col.a = 1.0f;
					half4 tint = tex2D( _MainTex, i.uvmain);
					half4 finalCol=fixed4(0,0,0,0);
