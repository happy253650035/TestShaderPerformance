Shader "ZJY/Effect/Particles/DDZFlowMask_Add" 
{
    Properties 
	{
    ...
    SubShader 
	{
        ...
        Pass 
		{
            ...
            float4 frag(VertexOutput i) : COLOR 
			{
					...
					float4 finalColor;
					finalColor.rgb=(baseCol.rgb*maskCol.a)*_TintCol.rgb+fresnel;
					finalColor.a=((fresnel.r+fresnel.g+fresnel.b)+maskCol.a*_TintCol.a)*i.color.a;
					//finalColor.rgb+=fresnel;
					//finalColor.a*=maskCol.a;
				
					return finalColor;
					//return fixed4(finalColor.a,finalColor.a,finalColor.a,1);
            }
            ENDCG
        }
    }
